        ...
        <div className="insurance-claims-card1">
          <div className="text-claim-cards-container">
            <p>
              ...
              clients, from the initial submission of the claim to the
        ...
        <div className="insurance-claims-card2">
          <div className="text-claim-cards-container">
            <p>
              ...
              state quickly and efficiently. Our commitment is to ensure that
              our clients receive the best possible service and return to
              enjoying the safety and comfort of their home as soon as possible.
            </p>
          </div>
